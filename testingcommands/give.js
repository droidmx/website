                            ...
                            if (to_give_amount < 0) {
                                msg.channel.send({
                                    embed: {
                                        ...
                                        description: "You must specify a positive integer to give."
                                    }
                                });
                            }
                            else {
                                            ...
                                            db.run(`Update "${db_userdata}" Set balance = ${giver_row.balance - to_give_amount} Where userid = ${giver_row.userid}`).then(() => {
                                                msg.channel.send({
                                                    embed: {
                                                        ...
                                                        description: "<@" + giver_row.userid + "> has given <@" + to_give_row.userid + "> $" + format(to_give_amount) + "!"
                                                    }
                                                });
                                            });
                                        });
